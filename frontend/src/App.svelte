<script>
  ...
  const translations = {
    en: {
      ...
      scanFootnoteWebScanner: 'Recursively crawls internal pages to check for broken links and inspects HTTP response headers for missing security settings.',
    ...
    ja: {
      ...
      scanFootnoteWebScanner: '同一ドメイン内の内部リンクを巡回し、リンク切れのチェックとHTTPセキュリティヘッダの脆弱性・欠落の検証を行います。',
